export const profile = {
  name: 'Karthik Tamil',
  title: 'Software Engineer · MS Computer Science, Santa Clara University',
  pitch:
  ...
  skills: [
    'Java', 'C', 'C++', 'Python', 'JavaScript', 'HTML/CSS', 'SQL', 'Dart',
  ...
  links: {
    github: 'https://github.com/karthiktamiledu',
    linkedin: 'https://linkedin.com/in/karthik-tamil',
    email: 'mailto:karthiktamiledu@gmail.com',
    cv: null,
  },
};
